          ...
          <div className='order'>
              ...
              <div className='order-table'>
                ...
                <div className='btn-wrap'>
                  ...
                  <button className='button button-green button-green--bordered'><OfferAcceptIcon />Accept</button>
                  ...
                  <button className='button button-primary button-primary--bordered'><OrderMeetingIcon />Meeting Room</button>
                </div>
              </div>
          </div>
        </div>
