                          ...
                          <div className="profile-details--right">
                            <div className="button-wrap">
                              ...
                              {user?.id === companyData?.id ? (
                                ...
                                <button className="button button-primary button-primary--bordered dropdown more-dropdown">
                                  <Link
                                    to={""}
                          ...
                          <div className="card-body">
                            <div className="card-lists">
                              {companyData?.products?.length > 0 ? (
                                ...
                                <>
                                  <h4 style={{ fontSize: "16px" }}>
                                    To get the business please create your
                                    product portfolio
                                  </h4>
                                </>
                              )}
                              ...
                              <div className="user-profile-content">
                                <div className="user-profile-name">
                                  ...
                                  <p className="text-medium">
                                    “We Greatly appreciated M-One Group for
                                    their kind support at every stage in terms
                                    of quality of the product, price and timely
                                    delivery”
                                  </p>
                                </div>
                              </div>
