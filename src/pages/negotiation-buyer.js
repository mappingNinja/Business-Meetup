              ...
              <div className='order-item'>
                ...
                <div className='content-block'>
                    ...
                    <div className='right'>
                      ...
                      <img src={InitialOfferIcon} />
                        <span className='status-label'>Initial offer Sent</span>
                      </div>
              ...
              <div className='order-item'>
                ...
                <div className='content-block'>
                    ...
                    <div className='right'>
                      <div className='status'>
                      <img src={InitialOfferIcon} />
                        <span className='status-label'>Initial offer</span>
                      </div>
                      <a className='view-btn'><LinkIcon />View Post</a>
                      <div className='btn-wrap'>
                      <button className='button button-green button-green--bordered btn-release'>request release order</button>
                        <button className='button button-green button-green--bordered btn-release'><SendIcon />Send Final Offer</button>
                ...
                <div className='content-block'>
                    ...
                    <div className='right'>
                      ...
                      <img src={OfferSentIcon} />
                        <span className='status-label'>Final offer sent</span>
                      </div>
                      <a className='view-btn'><LinkIcon />View Post</a>
...
export default NegotiationsBuyer
